...
<link rel="stylesheet" href="Sign-up.css" media="screen">
  ...
  <body class="u-body">
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="4038" data-image-height="2697" id="sec-115c">
      <div class="u-absolute-hcenter u-expanded u-opacity u-opacity-10 u-shape u-shape-rectangle u-white u-shape-1"></div>
      <p class="u-text u-text-default-xl u-text-1"> Sign Up to create an account</p>
      <div class="u-container-style u-group u-opacity u-opacity-25 u-radius-50 u-shape-round u-white u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <h2 class="u-align-center u-custom-font u-font-montserrat u-text u-text-2">Sign Up</h2>
          <div class="u-form u-form-1">
            ...
            <div class="u-form-email u-form-group">
                ...
                <input type="text" placeholder="Enter your username" name="username" class="u-grey-5 u-input u-input-rectangle u-input-1" required="" >
              </div> //username input

              <div class="u-form-group u-form-group-2">
                <label for="email" class="u-label u-label-2">Email</label>
                <input type= "email" placeholder="Enter your email" name="email" class="u-grey-5 u-input u-input-rectangle u-input-2" required="required" type="text">
              </div> // Email input

              <div class="u-form-group u-form-name">
                <label for="password1" class="u-label u-label-3">Password</label>
                <input type="password" placeholder="Enter your password" name="password1" class="u-grey-5 u-input u-input-rectangle u-input-3" required="">
              </div> //Password input

              <div class="u-form-group u-form-group-4">
                <label for="password2" class="u-label u-label-4">Confirm Password</label>
                <input type="password" placeholder="Confirm your password"  name="password2" class="u-grey-5 u-input u-input-rectangle u-input-4">
              </div> //Password confirmation input

        

              <div class="u-align-center u-form-group u-form-submit">
                <input type="submit" name = "submit" value="submit" class="u-active-palette-2-base u-border-none u-btn u-btn-submit u-button-style u-palette-1-base u-btn-1">
              
            </form>
          </div>
          <p class="u-align-center u-text u-text-3">Already have an account?&nbsp;<a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" href="Login.php" data-page-id="834002666">Login</a>
          </p>
        </div>
      </div>
    </section>
