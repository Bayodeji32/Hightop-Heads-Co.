...
if (isset($_POST['delete'])){
  $iname=$_POST['name'];
   $delete = "DELETE FROM cartlist where shoe_name='$iname' ";
...
<link rel="stylesheet" href="Cart.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-1-base u-header" id="sec-a81f"><div class="u-clearfix u-sheet u-sheet-1"><h2 class="u-custom-font u-font-georgia u-text u-text-default u-text-1">High-Top Hea​ds Co.</h2>
...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-white u-text-grey-90 u-text-hover-grey-90" href="Shoes.php" style="padding: 10px 0px;">Shoes</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Shoes.php" style="padding: 10px 0px;">Shoes</a>
...
<?php
$result = mysqli_query($conn,"SELECT * FROM cartlist");
?>
<?php
...
?>
<div class='tablemove'>
<table class='table' style="border: 0px solid white; border-collapse: collapse; width:50%;">
<tr style ="width:100%" >
<td  style="border: 1px solid black; border-collapse: collapse; background-color: #CDDDEE;width:50%;"> Shoe Name</td>
<td  style="border: 1px solid black; border-collapse: collapse; background-color: #CDDDEE;width:50%;"> Price</td>
...
<tr style ="width:100%" >
<td  style="border: 1px solid black; border-collapse: collapse; background-color: #CDDDEE;width:50%;"> <?php echo $row["shoe_name"]?> </td>
<td  style="border: 1px solid black; border-collapse: collapse; background-color: #CDDDEE;width:50%;"> <?php echo $row["shoe_price"]?></td>
<td  style="border: 1px solid black; border-collapse: collapse; background-color: #CDDDEE;width:50%;">
...
<form method='post'>
    ...
    <input type=hidden name="name" value="<?php echo $row["shoe_name"]; ?>">
</form>
<?php
?>
</td>
...
echo "No items in found in cart";
}
?>
</div>
</div>
...
<a href="Shoes.php" class="u-active-none u-btn u-button-style u-cart-continue-shopping u-hover-none u-none u-text-body-color u-btn-1"><span class="u-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 443.52 443.52" x="0px" y="0px" style="width: 1em; height: 1em;"><g><g><path d="M143.492,221.863L336.226,29.129c6.663-6.664,6.663-17.468,0-24.132c-6.665-6.662-17.468-6.662-24.132,0l-204.8,204.8    c-6.662,6.664-6.662,17.468,0,24.132l204.8,204.8c6.78,6.548,17.584,6.36,24.132-0.42c6.387-6.614,6.387-17.099,0-23.712    L143.492,221.863z"></path>
          ...
          <div class="u-cart-blocks-container">
            ...
            <div class="u-cart-block u-cart-totals-block u-indent-30">
              <div class="u-cart-block-container u-clearfix">
                <h5 class="u-cart-block-header u-text">Cart Summary</h5>
                <div class="u-align-right u-cart-block-content u-text">
                    ...
                    <table class="u-table-entity">
                      ...
                      <tbody class="u-align-right u-table-body">
                        <tr style="height: 46px;">
                          ...
                          $sql = "SELECT SUM(shoe_price) AS totalsum FROM cartlist";
                  ...
                  <a href="checkout.php" class="u-btn u-button-style u-cart-checkout-btn u-btn-4">Proceed to Checkout</a>
                </div>
              </div>
            </div>
          </div>
