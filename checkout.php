...
ob_end_clean();
    ...
    if(!empty($_POST['fullname'] && $_POST['address']&&$_POST['city'])&&$_POST['region']&& $_POST['cardname']&& $_POST['cardnumber']&&$_POST['expyear']&&$_POST['cvv']){ //checks if the various forms are not empty
        $fullname=$_POST['fullname']; // setting the form value in variable
        ...
        $cvv=  $_POST['cvv'];   
        $sql = "INSERT INTO `checkout` (fullname, address, city,region,cardname,cardnumber,expyear,cvv) VALUES ('$fullname', '$address','$city', '$region','$cardname', '$cardnumber', '$expyear','$cvv')";
  ...
  <div class="col-50">
    <div class="container">
      <form method ='post'>
        ...
        <input type="submit" name='check' value="Continue to checkout" class="btn"> </input>
